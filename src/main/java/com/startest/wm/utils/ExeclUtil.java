...
public class ExeclUtil {
     ...
     * @throws Exception
     */
    public static <T> void listtoExecl(List<T> data, HttpServletResponse out,
                                       Map<String, String> fields,String fileName) throws Exception {

        out.setHeader("Content-Disposition", "attachment;filename=" + new String(fileName.getBytes(), "iso-8859-1") + ".xls");
    ...
    public static <T> List<T> execltoList(MultipartFile multipartFile, Class<T> entityClass,
                                          Map<String, String> fields) throws Exception {
        if (multipartFile == null || multipartFile.isEmpty()||CollectionUtils.isEmpty(fields)||entityClass==null) {
            throw new Exception("参数错误");
        }

        String fileName = multipartFile.getOriginalFilename();
        if (fileName == null || fileName.length() <= 0) {
            throw new Exception("Excel文件路径为空！");
        }
        //判断文件类型
        ...
        return   execltoList(inputStream, entityClass, fields);
    }
